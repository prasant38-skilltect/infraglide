      ...
      <div className="px-4 py-2 border-t">
        <div className="flex flex-wrap gap-2 mb-3">
          <Badge 
            ...
            onClick={() => setInputMessage("Create an AWS S3 bucket with versioning")}
          >
            AWS S3 Example
          </Badge>
          <Badge 
            variant="outline" 
            className="cursor-pointer hover:bg-gray-100" 
            onClick={() => setInputMessage("Show me Terraform for Google Compute Engine")}
          >
            GCP Compute Example
          </Badge>
          <Badge 
          ...
          <Badge 
            variant="outline" 
            className="cursor-pointer hover:bg-gray-100" 
            onClick={() => setInputMessage("Best practices for cloud architecture")}
          >
            Architecture Tips
          </Badge>
        </div>
